...
// ```
CURL_EXTERN int curl_formadd(void **_httppost, void **_last_post) ;
...
// ```
CURL_EXTERN void curl_formfree(void *_form) ;
...
// ```
CURL_EXTERN
int curl_formget(void *_form,
                 void *_arg,
                 size_t (*_append)(void*, const char*, size_t))
;
...
/* ================================================================ */
/* CURLOPT_* option constants — curl 8.x ABI compatible            */
/* Generated by curl-rs-ffi/build.rs                                */
/* ================================================================ */
...
#define CURLOPT_XFERINFOFUNCTION (CURLOPTTYPE_FUNCTIONPOINT + 56)
...
#define CURLOPT_XFERINFODATA (CURLOPTTYPE_CBPOINT + 219)
...
#define CURLOPT_MAIL_RCPT_ALLOWFAILS (CURLOPTTYPE_LONG + 290)
...
#define CURLOPT_WS_OPTIONS (CURLOPTTYPE_LONG + 320)
#define CURLOPT_CA_CACHE_TIMEOUT (CURLOPTTYPE_LONG + 321)
#define CURLOPT_QUICK_EXIT (CURLOPTTYPE_LONG + 322)
#define CURLOPT_HAPROXY_CLIENT_IP (CURLOPTTYPE_STRINGPOINT + 323)
#define CURLOPT_SERVER_RESPONSE_TIMEOUT_MS (CURLOPTTYPE_LONG + 324)
#define CURLOPT_ECH (CURLOPTTYPE_STRINGPOINT + 325)
#define CURLOPT_TCP_KEEPCNT (CURLOPTTYPE_LONG + 326)
#define CURLOPT_UPLOAD_FLAGS (CURLOPTTYPE_LONG + 327)
#define CURLOPT_HTTPBASEHEADER (CURLOPTTYPE_SLISTPOINT + 328)
...
/* ================================================================ */
/* CURLINFO_* query constants — curl 8.x ABI compatible            */
/* ================================================================ */
...
#define CURLINFO_POSTTRANSFER_TIME_T (CURLINFO_OFF_T + 67)
#define CURLINFO_EARLYDATA_SENT_T (CURLINFO_OFF_T + 68)

/* Deprecated CURLINFO aliases */
#define CURLINFO_HTTP_CODE CURLINFO_RESPONSE_CODE
#define CURLINFO_LASTSOCKET 0x500000 + 29
